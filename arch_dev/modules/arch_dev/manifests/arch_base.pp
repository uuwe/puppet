...
class arch_dev::arch_base {
  ...
  file {'/etc/makepkg.conf':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/arch_dev/makepkg.conf',
  }
  ...
  file {'/etc/puppet/manifests/site.pp':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/arch_dev/site.pp',
  }
  ...
  file {'/usr/local/bin/maketmpdirs.sh':
    ...
    group  => 'root',
    mode   => '0755',
    source => 'puppet:///modules/arch_dev/maketmpdirs.sh',
  }
  file {'/etc/systemd/system/maketmpdirs.service':
    ...
    group   => 'root',
    mode    => '0755',
    source  => 'puppet:///modules/arch_dev/maketmpdirs.service',
